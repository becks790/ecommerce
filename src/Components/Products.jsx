...
export default function Products({ product }) {
  ...
  return (
    <div className="product px-2 py-2 cursor-pointer">
      ...
      <Link to={"/productDetails/" + product.id} className="a text-decoration-none">
      ...
      <button onClick={() => addProductToCart(product.id)} className="btn bg-danger w-100">+ Add To Cart</button>
    </div>
  );
}
